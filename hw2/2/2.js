...
const initialData = [
  {
    ...
    reviews: [
      {
        id: Date.now(),
        text: "Отличный телефон! Долго держится заряд батареи.",
      },
      {
        id: Date.now(),
        text: "Камера отличная, фото выглядят просто потрясающе.",
      },
    ],
  },
  {
    product: "Samsung Galaxy 3",
    reviews: [
      {
        id: Date.now(),
        text: "Интересный дизайн, но очень дорогой.",
      },
    ],
  },
  {
    ...
    reviews: [
      {
        id: Date.now(),
        text: "Графика на высоте, но теперь не поиграешь...",
      },
    ],
  },
];
